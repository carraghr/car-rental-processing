...
public class CarResult{
	...
	public boolean equals(CarResult car) {
		return this.description.equals(car.description) &
				this.sippCode.equals(car.sippCode) &
				this.supplierName.equals(supplierName) &
				this.fuelPolicy.equals(car.fuelPolicy);
	}
}
